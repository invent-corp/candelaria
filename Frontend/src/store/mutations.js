const mutations = {
	...
	UPDATE_USER_INFO(state, payload) {
		...
		let userInfo = JSON.parse(localStorage.getItem("userInfo")) || state.AppActiveUsuario

		for (const property of Object.keys(payload)) {
			if (payload[property] != null) {
				// If some of user property is null - user default property defined in state.AppActiveUsuario
				state.AppActiveUsuario[property] = payload[property]
