                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ acessos.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : acessos.length }} of {{ acessos.length }}</span>
		...
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Nome", "Código", "Status"],
                    headerVal: ["nome", "codigo", "situacao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Acessos",
		...
		beforeMount() {
          ...
          methods: {
			loadData() {
                    ...
                    axios.get(`${backendUrl}/acessoa/${adm}`)
                    .then(res => {this.acessos = res.data}) 
			},
               Autosize() {
                    var allColumnIds = []
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Acessos'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Acessos'
                    }
