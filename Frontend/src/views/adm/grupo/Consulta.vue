                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ grupos.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : grupos.length }} of {{ grupos.length }}</span>
		...
		beforeMount() {
          ...
          methods: {
			loadData() {
                    ...
                    axios.get(`${backendUrl}/grupoa/${adm}`)
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Grupos'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Grupos'
                    }
