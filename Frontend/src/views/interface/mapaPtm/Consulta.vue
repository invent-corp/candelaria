                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ mapasPtm.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : mapasPtm.length }} of {{ mapasPtm.length }}</span>
...
<script>
	...
	export default {
			...
			return {
				...
				defaultColDef: {
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Mapa PTM",
		...
		beforeMount() {
          ...
          methods: {
			loadData() {
				axios.get(`${backendUrl}/mapaPtm`)
				.then(res => {this.mapasPtm = res.data})
			},
               Autosize() {
                    var allColumnIds = []
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Mapa PTM'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Mapa PTM'
                    }
