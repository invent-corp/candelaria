                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ mapasPtls.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : mapasPtls.length }} of {{ mapasPtls.length }}</span>
			...
			return {
				...
				defaultColDef: {
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Mapa PTL",
			...
			loadData() {
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Mapa PTL'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Mapa PTL'
                    }
