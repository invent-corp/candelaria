                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ pickings.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : pickings.length }} of {{ pickings.length }}</span>
		...
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Descrição", "Código", "Gateway", "Gateway Detalhes", "IP", "Porta", "Coletor", "Status"],
                    headerVal: ["descricao", "codigo", "gateway", "detalhes", "ip", "porta", "coletor", "situacao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Pickings",
			...
			loadData() {
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Pickings'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Pickings'
                    }
