	...
	<div id="page-user-list">
          ...
          <div class="vx-card p-6">
               ...
               <div class="flex flex-wrap items-center">
                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ sorter.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : sorter.length }} of {{ sorter.length }}</span>
                    ...
                    <v-select id="filter-text-box" class="shadow-drop rounded-lg sm:mr-4 sm:order-normal w-64 text-sm" placeholder="Selecione o Mapa Sorter" v-model="searchQuery" @input="updateSearchQuery" :options=mapasSorters :reduce="nome => nome.nome" label="nome">
                    </v-select>
...
import ChangeTimeDurationDropdownVue from '../../../components/dashboard/ChangeTimeDurationDropdown.vue';
	...
	export default {
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Mapa Sorter", "Mapa Descrição", "Mapa", "Rampa", "Rampa", "Rampa Descrição"],
                    headerVal: ["mapa_sorter", "mapa_descricao", "mapa_situacao", "rampa", "rampa_situacao", "rampa_descricao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Sorters",
		...
		beforeMount() {
			...
			this.columnDefs = [
				{
				headerName: 'Mapa Sorter',
				field: 'mapa_sorter',
                    filter: ChangeTimeDurationDropdownVue,
                    minWidth: 300,
				...
				field: 'rampa',
                    ...
                    {
				headerName: 'Rampa',
				field: 'rampa_situacao',
                    filter: false,
                    cellRendererFramework: 'CellRendererStatus'			
				},
                    {
				headerName: 'Rampa Descrição',
				field: 'rampa_descricao',
                    filter: false,			
				},
				{
				headerName: 'Ações',
		...
		methods: {
			loadData() {
				axios.get(`${backendUrl}/sorter`)
				.then(res => {this.sorter = res.data})

                    axios.get(`${backendUrl}/sortercbx`)
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Sorters'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Sorters'
                    }
