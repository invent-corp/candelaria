                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ gateways.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : gateways.length }} of {{ gateways.length }}</span>
		...
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Nome", "Descrição", "IP", "Porta", "Status"],
                    headerVal: ["nome", "descricao", "ip", "porta", "situacao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Gateways",
			...
			loadData() {
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Gateways'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Gateways'
                    }
