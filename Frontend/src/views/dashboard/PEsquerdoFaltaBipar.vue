		...
		<div class="vx-row">
			...
			<div class="vx-col w-1/6">
				...
				<vx-card class="rounded-lg text-sm sm:mt-0 mt-1">
					...
					<div class="sm:mt-1 text-xl" id="data-reload"></div>
					</div>
...
export default{
    ...
    methods: {
		...
		loadData() {
			axios.get(`${backendUrl}/dashesquerdofaltabipar/`)
		...
		//	reloadesq = 60
			this.intervalo_contador = setInterval(() => {
				reloadesq--
				document.getElementById('data-reload').innerHTML = 'Próx. Atual. em: '+reloadesq+' sec.'
			}, 1000)
