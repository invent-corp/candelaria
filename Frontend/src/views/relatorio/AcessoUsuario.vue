                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ acessoUsuario.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : acessoUsuario.length }} of {{ acessoUsuario.length }}</span>
...
<script>
	...
	export default {
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Usuário", "Função", "Acesso", "Status"],
                    headerVal: ["nome", "funcao", "acesso", "situacao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Relatório | Acessos Usuários",
		...
		beforeMount() {
          ...
          methods: {
			loadData() {
				axios.get(`${backendUrl}/acessousuario`)
				.then(res => {this.acessoUsuario = res.data})
			},
               Autosize() {
                    var allColumnIds = []
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Acessos Usuarios'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Acessos Usuarios'
                    }
