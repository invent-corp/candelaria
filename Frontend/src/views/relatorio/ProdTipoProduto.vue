                                ...
                                <div>
                                    <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                                        ...
                                        <div class="p-3 mr-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                            <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ prodtipoproduto.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : prodtipoproduto.length }} of {{ prodtipoproduto.length }}</span>
	...
	export default {
		data() {
			return {
                ...
                headerTitle: ["Qtde", "Família Produto"],
                headerVal: ["qtde_produto", "descricao"],
                selectedUsers: [],
                //EXPORT PDF
                fileNamePDF: "",
                formatsPDF:"pdf",
                ...
                printParams: {
                        ...
                        PDF_PAGE_NAME: "Relatório | Produção X Família Produto",
                ...
                barChart: {
                    ...
                    chartOptions: {
                        colors: ['#ffc500', '#e5b100', '#cc9d00', '#b28900', '#997600', '#7f6200', '#664e00', '#4c3b00', '#332700' ],
                        plotOptions: {
                            bar: {
                                horizontal: false,
                                distributed: true,
                        ...
                        xaxis: {
                            categories: tipoproduto,
                            title: {
                                text: 'Quantidade Família Produto'
                            }
                        },
                        tooltip: {
                            y: {
		...
		methods: {
			loadData() {
				...
				axios.get(`${backendUrl}/prodtipoproduto/${inicial}&${final}`)
				.then(res => {this.prodtipoproduto = res.data})
            ...
            filtro() {
				...
				axios.get(`${backendUrl}/prodtipoproduto/${dataInicial}&${dataFinal}`)
				.then(res => {this.prodtipoproduto = res.data
                    if(this.prodtipoproduto != ''){
                        this.barChart.chartOptions.subtitle= {
                        ...
                        for (let i = 0; ;i++) {
                            tipoproduto[i] = this.prodtipoproduto[i].descricao  
                            producao[i] = this.prodtipoproduto[i].qtde_produto
                        }
                    } 
                    if(this.prodtipoproduto == '') {
                        this.barChart.chartOptions.subtitle= {
            ...
            exportToExcel() {
                import('@/components/excel/Export2Excel').then(excel => {
                    ...
                    this.fileNameExcel = 'Invent - Prod Família Produto'
                    }
            ...
            exportToPDF() {
                ...
                if(this.fileNamePDF == '' || null) {
                    this.fileNamePDF = 'Invent - Prod Família Produto'
                }
