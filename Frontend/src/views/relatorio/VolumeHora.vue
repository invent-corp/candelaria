        ...
        <vx-card>
            <div slot="no-body" class="tabs-container px-4 pt-4">
                ...
                <vs-tabs v-model="activeTab">
                    ...
                    - 1) }} - {{ volumehora.length - currentPage * paginationPageSize > 0 ?
                    currentPage * paginationPageSize : volumehora.length }} of {{
                    volumehora.length }}</span>
                            ...
                            <ag-grid-vue style="height: 370px" ref="agGridTable"
                                ...
                                :rowData="volumehora" :animateRows="true" :pagination="true"
                    ...
                    <vs-tab label="Gráfico" icon-pack="feather" icon="icon-pie-chart">
                        ...
                        <vx-card>
                            ...
                            <div slot="no-body">
                                ...
                                <vue-apex-charts type=area height="350" :options="lineChart.chartOptions"
                                    :series="lineChart.series"></vue-apex-charts>
                            </div>
...
export default {
    data() {
        return {
            ...
            headerTitle: ["Data", "Tipo", "Qtde"],
            headerVal: ["data", "tipo", "qtde"],
            selectedUsers: [],
            //EXPORT PDF
            fileNamePDF: "",
            formatsPDF: "pdf",
            ...
            printParams: {
                ...
                PDF_PAGE_NAME: "Relatório | Volume X Hora",
    ...
    methods: {
        ...
        loadData() {
            ...
            var inicial = '1800-01-01'
            var final = '1800-01-01'
            axios.get(`${backendUrl}/volumehora/${inicial}&${final}`)
                .then(res => { this.volumehora = res.data })
            this.lineChart.chartOptions.subtitle = {
                text: "",
                align: 'left',
                margin: 0,
                offsetX: -10,
            ...
            this.lineChart.chartOptions.xaxis = {
                type: 'datetime',
                categories: []
            }
        },
        filtro() {
            ...
            axios.get(`${backendUrl}/volumehora/${dataInicial}&${dataFinal}`)
                .then(res => {
                    this.volumehora = res.data
                    if (this.volumehora != '') {
                        this.lineChart.chartOptions.subtitle = {
                        ...
                        for (let i = 0; ; i++) {
                            this.volumehora[i].data = this.volumehora[i].data.toString() + ':00:00'
                            datahora[i] = this.volumehora[i].data.substring(0, 16)
                            qtde[i] = this.volumehora[i].qtde
                        }
                    }
                    if (this.volumehora == '') {
                        this.lineChart.chartOptions.subtitle = {
        ...
        exportToExcel() {
            import('@/components/excel/Export2Excel').then(excel => {
                ...
                if (this.fileNameExcel == '' || null) {
                    this.fileNameExcel = 'Invent - Volume Hora'
                }
        ...
        exportToPDF() {
            ...
            if (this.fileNamePDF == '' || null) {
                this.fileNamePDF = 'Invent - Volume Hora'
            }
