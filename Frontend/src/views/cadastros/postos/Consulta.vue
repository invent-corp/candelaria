		...
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Descrição", "Pad Picking", "Status"],
                    headerVal: ["descricao", "pad_picking", "situacao"],
                    selectedUsers: [],
                    //EXPORT PDF
                    fileNamePDF: "",
                    formatsPDF:"pdf",
			...
			loadData() {
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Postos'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Postos'
                    }
