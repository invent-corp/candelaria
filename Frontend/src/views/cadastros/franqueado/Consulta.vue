                    ...
                    <div class="flex-grow">
                         ...
                         <vs-dropdown vs-trigger-click class="cursor-pointer text-sm">
                              ...
                              <div class="p-3 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                                   <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ franqueado.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : franqueado.length }} of {{ franqueado.length }}</span>
...
<script>
	...
	export default {
		data() {
			return {
				...
				defaultColDef: {
                    ...
                    headerTitle: ["Descrição", "Codigo", "Status"],
                    ...
                    printParams: {
                         ...
                         PDF_PAGE_NAME: "Consulta | Franqueados",
		...
		beforeMount() {
          ...
          methods: {
			loadData() {
				axios.get(`${backendUrl}/franqueado`)
               ...
               exportToExcel() {
                    import('@/components/excel/Export2Excel').then(excel => {
                         ...
                         this.fileNameExcel = 'Invent - Franqueados'
                         }
               ...
               exportToPDF() {
                    ...
                    if(this.fileNamePDF == '' || null) {
                         this.fileNamePDF = 'Invent - Franqueados'
                    }
